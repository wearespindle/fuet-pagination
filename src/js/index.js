...
module.exports = (function Paginator() {
    ...
    async function fetchData(context, pushRoute = true) {
        ...
        const response = await this.resource_action({
        ...
        if (response) this.updatePagination(currentPage, response)
    }
    ...
    function updatePagination(currentPage, context) {
        ...
        const pageCount = Math.ceil(context.count / this.pageSize)
        let renderPages = []
    ...
    return {
        ...
        props: ['count', 'resource_action', 'resource_url'],
        /**
